...
export const INITIAL_USER_PROFILES: UserProfile[] = [
  {
    ...
    descripcion: 'Control total de la plataforma, configuración global, gestión de compras, disponibilidad presupuestaria, judicaturas, usuarios, perfiles y bitácoras.',
    esSistema: true,
    color: 'rose',
    modulosPermitidos: ['dashboard', 'compras', 'judicaturas', 'presupuesto', 'catalogos', 'auditoria', 'usuarios', 'reportes', 'personalizacion', 'correo'],
    activo: true,
  ...
  },
  {
    ...
    descripcion: 'Supervisión y fiscalización sin alteración. Acceso a paneles ejecutivos, compras, judicaturas, presupuesto, reportes y bitácora de auditoría inmutable.',
    esSistema: true,
    color: 'amber',
    modulosPermitidos: ['dashboard', 'compras', 'judicaturas', 'presupuesto', 'reportes', 'auditoria'],
    activo: true,
    fechaCreacion: '2024-01-01T08:00:00Z'
  },
  {
    ...
    esSistema: true,
    color: 'blue',
    modulosPermitidos: ['dashboard', 'compras', 'judicaturas', 'reportes'],
    activo: true,
    fechaCreacion: '2024-01-01T08:00:00Z'
  },
  {
