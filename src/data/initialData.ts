...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    dobleFactorHabilitado: true,
    metodoPreferido2FA: 'totp',
    totpSecret: 'AVON2XNZG3F5ETYBADAR',
  ...
  },
  {
    ...
    dobleFactorHabilitado: true,
    metodoPreferido2FA: 'totp',
    totpSecret: '4XOP2VP3GZH7ARUD45TX',
  ...
  },
  {
    ...
    dobleFactorHabilitado: true,
    metodoPreferido2FA: 'totp',
    totpSecret: 'U7GHS5HTORPXIZ4LU7Z7',
    fechaCreacion: '2024-04-10T08:30:00Z',
    ultimoAcceso: '2026-09-02T16:10:00Z',
  },
  {
    id: 'usr-presupuesto-1',
    username: 'edmonroy',
    nombreCompleto: 'Ing. Edwin David Monroy',
    email: 'edmonroy@oj.gob.gt',
    telefono: '+502 5555-0155',
    password: 'user123',
    rol: 'usuario_estandar',
    perfilId: 'prof-presupuesto',
    cargo: 'Especialista en Presupuesto y Finanzas',
    departamento: 'Gerencia Financiera - OJ',
    activo: true,
    dobleFactorHabilitado: true,
    metodoPreferido2FA: 'totp',
    totpSecret: 'LAZYNCYMROQIXGDUL6YA',
    fechaCreacion: '2024-02-15T08:00:00Z',
    ultimoAcceso: '2026-09-02T10:00:00Z',
  },
  {
    id: 'usr-compras-2',
    username: 'mmvaldez',
    nombreCompleto: 'Licda. Maria Mercedes Valdez',
    email: 'mmvaldez@oj.gob.gt',
    telefono: '+502 5555-0166',
    password: 'user123',
    rol: 'usuario_estandar',
    perfilId: 'prof-compras',
    cargo: 'Especialista de Adquisiciones GIT',
    departamento: 'Unidad de Gestión de Adquisiciones GIT',
    activo: true,
    dobleFactorHabilitado: true,
    metodoPreferido2FA: 'totp',
    totpSecret: 'YTKL6RL7C5D3EVQHY5A7',
    fechaCreacion: '2024-03-01T08:00:00Z',
    ultimoAcceso: '2026-09-02T12:00:00Z',
  }
];
