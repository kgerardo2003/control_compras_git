      ...
      <div className="relative w-full max-w-md bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden my-8">
        ...
        <div className="bg-[#0d1f4d] p-6 text-white text-center relative border-b border-[#1c39bb]/40">
          ...
          <p className="text-xs text-[#93c5fd] mt-0.5">
            Gerencia de Informática • Acceso al Sistema Institucional
          </p>
        </div>
          ...
          {step === 'credentials' && (
            <form onSubmit={handleCredentialsSubmit} className="space-y-4">
              ...
              <button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full py-2.5 px-4 rounded-xl bg-[#0d1f4d] hover:bg-[#162e7a] text-white font-bold text-xs shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer border border-[#1c39bb]/50 active:scale-95 mt-4"
              >
                {isLoading ? (
